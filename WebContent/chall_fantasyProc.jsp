			...
			<ul class="chall_img_list">
				...
				<div class="chall_secondgroup">
					...
					<dl>
						...
						<dd class="chall_all_view">만화 소<li><a href="#"><img src="https://shared-comic.pstatic.net/thumb/nas/user_contents_data/challenge_comic/2019/03/24/fixsit/title_thumbnail_034208_83x90.jpg"></a>
					<dl>
